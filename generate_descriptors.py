...
def obtain_descriptors_and_save(filename, class_list):
    ...
    responses = []
    for prompt_partition in partition(prompts, 20):
        for prompt in prompt_partition:
...
#obtain_descriptors_and_save('CIFAR100_Description', [
...
#obtain_descriptors_and_save('CIFAR10_Description', [
#    "airplane", "automobile", "bird", "cat", "deer", 
#        "dog", "frog", "horse", "ship", "truck"
#])

obtain_descriptors_and_save('ImageNet_Description', [
    ...
    "black_and_tan_coonhound", "Walker_hound", "English_foxhound", "redbone", "borzoi", 
    ...
    "Norfolk_terrier", "Norwich_terrier", "Yorkshire_terrier", "wire_haired_fox_terrier", "Lakeland_terrier", 
    ...
    "Tibetan_terrier", "silky_terrier", "soft_coated_wheaten_terrier", "West_Highland_white_terrier", "Lhasa", 
    "flat_coated_retriever", "curly_coated_retriever", "golden_retriever", "Labrador_retriever", "Chesapeake_Bay_retriever", 
    ...
    "llama", "weasel", "mink", "polecat", "black_footed_ferret", 
    "otter", "skunk", "badger", "armadillo", "three_toed_sloth", 
    ...
    "beer_bottle", "beer_glass", "bell_cote", "bib", "bicycle_built_for_two", 
    ...
    "car_mirror", "carousel", "carpenters_kit", "carton", "car_wheel", 
    ...
    "football_helmet", "forklift", "fountain", "fountain_pen", "four_poster", 
    "freight_car", "French_horn", "frying_pan", "fur_coat", "garbage_truck", 
    "gasmask", "gas_pump", "goblet", "go_kart", "golf_ball", 
    ...
    "iPod", "iron", "jack_o_lantern", "jean", "jeep", 
    ...
    "pill_bottle", "pillow", "ping_pong_ball", "pinwheel", "pirate", 
    "pitcher", "plane", "planetarium", "plastic_bag", "plate_rack", 
    "plow", "plunger", "Polaroid_camera", "pole", "police_van", 
    "poncho", "pool_table", "pop_bottle", "pot", "potters_wheel", 
    ...
    "daisy", "yellow_ladys_slipper", "corn", "acorn", "hip", 
